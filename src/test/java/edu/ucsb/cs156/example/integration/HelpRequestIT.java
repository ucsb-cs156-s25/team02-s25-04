...
public class HelpRequestIT {
    ...
    public void an_admin_user_can_post_a_new_helpRequest() throws Exception {
        ...
        HelpRequest helpRequest1 = HelpRequest.builder()
                ...
                .requestTime(ldt1)
                .explanation("Need help with my testing")
                .solved(true)
                .build();

        // act
        MvcResult response = mockMvc.perform(
                post("/api/HelpRequest/post?requesterEmail=test2@ucsb.edu&teamId=s25-5pm-04&tableOrBreakoutRoom=5&requestTime=2025-10-01T12:00:00&explanation=Need help with my testing&solved=true")
                        .with(csrf()))
                .andExpect(status().isOk()).andReturn();
