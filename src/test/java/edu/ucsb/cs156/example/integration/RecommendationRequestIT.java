...
public class RecommendationRequestIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    RecommendationRequest recommendationRequest1 = RecommendationRequest.builder()
        ...
        .dateRequested(ldt1)
        .explanation("Need a recommendation letter")
        .build();
  ...
  public void an_admin_user_can_post_a_new_recommendationRequest() throws Exception {
    // arrange
    LocalDateTime ldt1 = LocalDateTime.parse("2025-10-01T12:00:00");
    ...
    MvcResult response = mockMvc.perform(
        post(
            "/api/recommendationrequests/post?requesterEmail=test2@ucsb.edu&professorEmail=professor2@ucsb.edu&dateRequested=2025-10-01T12:00:00&explanation=Need a recommendation letter for graduate school")
            .with(csrf()))
        .andExpect(status().isOk()).andReturn();
