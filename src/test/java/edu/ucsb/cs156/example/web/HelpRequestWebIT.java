...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_helpRequest() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-teamId").fill("s25-6pm-07");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("7");
        page.getByTestId("HelpRequestForm-requestTime").fill("2025-05-01T12:32");
        page.getByTestId("HelpRequestForm-explanation").fill("I need help with End 2 End testing");
        page.getByTestId("HelpRequestForm-solved").uncheck();
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("test@ucsb.edu(edited)");
        page.getByTestId("HelpRequestForm-teamId").fill("s25-6pm-07(edited)");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("7(edited)");
        page.getByTestId("HelpRequestForm-requestTime").fill("2025-05-01T12:33");
        page.getByTestId("HelpRequestForm-explanation").fill("I need help with End 2 End testing(edited)");
        page.getByTestId("HelpRequestForm-solved").uncheck();
        
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-requesterEmail"))
                .hasText("test@ucsb.edu(edited)");
    ...
    @Test
    public void regular_user_cannot_see_delete_button() throws Exception {
        setupUser(false);

        page.getByText("Help Requests").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-Delete-button")).not().isVisible();
    }
}