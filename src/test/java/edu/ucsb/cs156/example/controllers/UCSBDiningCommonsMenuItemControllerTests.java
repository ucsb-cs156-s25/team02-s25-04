...
public class UCSBDiningCommonsMenuItemControllerTests extends ControllerTestCase {
        ...
        public void an_admin_user_can_post_a_new_ucsbdiningcommonsmenuitem() throws Exception {
                ...
                when(ucsbDiningCommonsMenuItemRepository.save(eq(ucsbDiningCommonsMenuItem))).thenReturn(ucsbDiningCommonsMenuItem);
                // act
                MvcResult response = mockMvc.perform(
                                post("/api/ucsbdiningcommonsmenuitem/post?diningCommonsCode=Portola&name=Salad&station=Salad Bar")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
                // assert
        ...
        @WithMockUser(roles = { "ADMIN", "USER" })
        @Test
        public void admin_cannot_edit_ucsbdiningcommonsmenuitem_when_id_does_not_exist() throws Exception {
                // arrange
        ...
        @WithMockUser(roles = { "ADMIN", "USER" })
        @Test
        public void admin_tries_to_delete_non_existant_dining_commons_menu_item_and_gets_right_error_message()
                        throws Exception {
                // arrange
